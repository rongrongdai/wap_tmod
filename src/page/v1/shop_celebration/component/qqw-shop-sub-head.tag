...
<qqw-shop-sub-head>
<!-- <qqwhead></qqwhead> -->
<div class="qqw_good_head_box">
    <div class="qqw_head">
        <div class="swiper-container  sweephead shop-sweephead"  style="background:{opts.colorlist.qian}" >
    ...
    this.switch_head = (e)=>{
             ...
             self.root.getElementsByTagName('li')[i].style.color='#323232';
             }
             self.root.getElementsByTagName('li')[index].style.background=opts.colorlist.shen;
             self.root.getElementsByTagName('li')[index].style.color='#fff';
             changeState(index);
    ...
    function initSwiper(){
              ...
              var swipers = new  window.Swiper('.shop-sweephead', {
               slidesPerView: count,
       ...
       self.root.getElementsByTagName('li')[0].style.color='#fff';
   }
    </script>
</qqw-shop-sub-head>