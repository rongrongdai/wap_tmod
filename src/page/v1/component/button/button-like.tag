...
<button-like>
	<button class="button-like" onclick={ likeClick }>
		<img class="button-like-sign button-like-sign--active" src="/static/css/product_funding/funding/app_img/icon_like@2x.png" if="{ speclife.islove === '1' }" data-loveid="{ speclife.id }" data-lovenum="{ speclife.lovenum }">
		<img class="button-like-sign" src="/static/css/product_funding/funding/app_img/icon_unlike@2x.png" if="{ speclife.islove === '0' }" data-loveid="{ speclife.id }" data-lovenum="{ speclife.lovenum }">
		<span class="button-like-text">{ speclife.lovenum }</span>
	</button>
